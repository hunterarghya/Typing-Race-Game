  ...
  socket.onmessage = (event) => {
    ...
    if (data.type === "PLAYER_READY") {
      document.getElementById("lobby-status").innerText =
        "Opponent is ready! Click yours... Go full screen (F11) for best experience";
    }
...
function initGame() {
  ...
  const arenaMain = document.getElementById("arena-main");
  if (arenaMain) arenaMain.scrollTop = 0;
